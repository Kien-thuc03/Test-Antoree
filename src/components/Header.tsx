        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center mb-4 md:mb-0">
            <Link to="/" className="flex items-center">
              ...
              <span className="font-bold text-xl">EduTech Hub</span>
            </Link>
          </div>
          ...
          <form onSubmit={handleSearch} className="w-full md:w-1/2 mb-4 md:mb-0">
            <div className="relative">
              ...
              <button 
                type="submit" 
                className="absolute right-0 top-0 h-full px-4 flex items-center justify-center text-gray-500 hover:text-blue-600"
                aria-label="Tìm kiếm"
              >
          ...
          <div className="flex items-center space-x-4">
            <Link to="/favorites" className="flex items-center hover:text-blue-200 transition-colors">
